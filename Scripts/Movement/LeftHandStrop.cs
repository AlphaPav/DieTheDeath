...
public class LeftHandStrop : MonoBehaviour {
	...
	void Update () {
		if(Global.state == Global.STROP_L)
        {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (Global.state == Global.IDLE || Global.state == Global.SPIN_R || Global.state == Global.READY_SPIN_R || Global.state == Global.CLIMB_R)
            {
                // Update state
                Global.state = Global.STROP_L;
